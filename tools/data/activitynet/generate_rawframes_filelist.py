...
data_file = '/home/zhiyuan/mmaction2-master'
video_list = f'{data_file}/video_info_new.csv'
anno_file = f'{data_file}/anet_anno_action.json'
rawframe_dir = "/data0/zhiyuan/anet1.3"
action_name_list = 'action_name.csv'

train_rawframe_dir = "/data2/zyl/workspace/video_datasets/anet1.3_train_frames"
val_rawframe_dir = "/data2/zyl/workspace/video_datasets/anet1.3_val_frames"
